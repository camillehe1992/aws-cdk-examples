...
import * as ThreeTiersNetworkCdk from '../lib/three-tiers-network-cdk-stack';
...
describe('ThreeTiersNetworkCdkStack', () => {
  ...
  beforeAll(() => {
    ...
    const stack = new ThreeTiersNetworkCdk.ThreeTiersNetworkCdkStack(app, 'ThreeTiersNetworkCdkStack');
